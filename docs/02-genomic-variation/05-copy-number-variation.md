...
reference genome and determining the read depth, or coverage (TODO ACF 2025-06-04: `read depth` and `coverage` should be defined). In theory, the
coverage should reflect the relative copy number (TODO ACF 2025-06-04: copy number... frequency? likelihood? identifier?). In practice, some DNA regions
...
local counts, and sequence machine errors give inflated quality estimates (TODO ACF 2025-06-04: what's a quality estimate and why is it relevant here? might be better to leave out the specific errors and just attribute these difficulties to a more abstract sequence machine fidelity issue) for
